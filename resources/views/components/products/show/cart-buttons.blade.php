@if($sku->cartedBy->pluck('id')->contains(auth()->id()))
    <div class="flex justify-between gap-2">
        ...
        <div class="flex bg-blue-600 rounded-full">
            <button wire:click.throttle="addToCart({{$sku->id}}, 10)" class="flex items-center px-2 rounded-full hover:bg-blue-400 text-white">
                <img src="/images/button-icons/plus.svg" class="size-3" />
