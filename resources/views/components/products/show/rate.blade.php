<x-dialog wire:model="showModal">
    <x-dialog.open>
        <button class="text-sm bg-blue-600 px-4 py-1 rounded-full text-white font-medium flex items-center">
            <img src="/star-outline.svg" class="w-4 h-4 mr-1 fill-white">
